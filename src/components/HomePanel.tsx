...
export default function HomePanel({ setCurrentPage, onOpenSignUp }: HomePanelProps) {
  ...
  return (
    <div id="home-panel-root" className="bg-white text-[#1C1C1C] overflow-x-hidden font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-left">
              ...
              <div className="space-y-4">
                ...
                <motion.p
                  ...
                  className="text-slate-600 text-base sm:text-lg leading-relaxed max-w-2xl font-sans"
                >
              ...
              <motion.div
                ...
                className="pt-10 border-t border-slate-200 grid grid-cols-2 sm:grid-cols-3 gap-6 font-mono text-slate-400 text-[10px] uppercase tracking-widest"
              >
                <div className="flex flex-col items-start">
                  <span className="block text-xl font-serif text-slate-800 font-bold tracking-tight mb-1">MÉTODO</span>
                ...
                <div className="col-span-2 sm:col-span-1 flex flex-col items-start">
                  <span className="block text-xl font-serif text-slate-800 font-bold tracking-tight mb-1">SEDE</span>
            ...
            >
              ...
              <div className="relative mx-auto max-w-[420px] lg:max-w-none rounded-3xl p-6 bg-white border border-slate-200/80 shadow-[0_20px_50px_rgba(10,46,93,0.08)] overflow-hidden flex flex-col justify-between">
                
                {/* Overlay Radial Lighting effects */}
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(200,155,60,0.05),transparent_65%)] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 text-left space-y-6">
              ...
              <div className="space-y-5 text-sm text-[#1C1C1C]/75 leading-relaxed font-sans">
                ...
                <p>
                  Atuamos como um acelerador intelectual focado em Angola, com o planeamento voltado para a oferta de múltiplos cursos especializados e de proficiência gerais. Unimos formadores qualificados e infraestrutura moderna para expandir o seu valor de mercado.
                </p>
              </div>
      ...
      <section className="py-24 relative bg-slate-50/30 border-t border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-24 bg-white relative border-b border-slate-100 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center items-center relative z-10">
            <div className="w-full max-w-[340px] md:max-w-none flex justify-center">
              <Carousel
                baseWidth={320}
                autoplay={true}
                autoplayDelay={4000}
            ...
            >
              ...
              <div className="lg:col-span-5 bg-slate-50 text-slate-800 p-8 sm:p-12 relative flex flex-col justify-between overflow-hidden text-left border-r border-slate-100">
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <h4 className="text-2xl sm:text-3xl font-serif font-bold tracking-normal leading-tight text-slate-900 m-0">
                    {PRINCIPAL_COURSE.title}
                  </h4>
                  
                  <p className="text-xs sm:text-sm text-slate-600 font-sans leading-relaxed m-0">
      ...
      <section className="py-24 relative bg-slate-50/50 border-t border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row gap-4 items-center justify-between">
                <div className="flex flex-wrap gap-1.5 self-start">
                  {MAIN_INSTRUCTOR.specializations.map((spec, sIdx) => (
                    <span key={sIdx} className="bg-slate-100 px-2.5 py-1 rounded text-[9px] font-mono text-slate-500 font-bold uppercase">
                      {spec}
                    </span>
                  ))}
                </div>
      ...
      <section className="py-24 relative bg-slate-50/50 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
            ...
            <div className="lg:col-span-7 flex flex-col justify-stretch">
              <div className="rounded-3xl overflow-hidden p-3 bg-white border border-slate-200 flex-1 flex flex-col">
                ...
                <div className="flex-grow bg-white relative p-5 flex flex-col justify-between min-h-[360px] rounded-2xl m-1 border border-slate-200 shadow-inner overflow-hidden">
                  ...
                  <svg viewBox="0 0 540 280" className="w-full h-full relative z-10 text-slate-750/60 transition-all select-none opacity-90 animate-fadeIn">
                    ...
                    <g fill="#475569" fontSize="7" fontFamily="monospace" letterSpacing="0.5" opacity="0.95">
                      ...
                      <text x="48" y="88" fill="#64748B">HOUSTON</text>
                      <text x="350" y="113" fill="#475569">DUBAI</text>
                    </g>
