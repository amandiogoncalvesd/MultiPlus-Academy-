  ...
  return (
    <div id="new-conv-modal" className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <motion.div 
        ...
        className="bg-cream-100 dark:bg-ink-950 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] w-full max-w-md overflow-hidden border border-gray-250 dark:border-ink-800 flex flex-col max-h-[85vh]"
      >
        ...
        <div className="p-4 border-b border-gray-150 dark:border-ink-800 bg-cream-100 dark:bg-ink-950">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 border border-gray-250 dark:border-ink-800 rounded-full text-xs focus:outline-none focus:ring-2 focus:ring-gold-600/20 focus:border-gold-600 transition-all bg-cream-200 dark:bg-ink-900 text-ink-900 dark:text-cream-100 placeholder:text-neutral-400"
            />
          </div>
        </div>

        <div className="flex-1 overflow-y-auto p-2 bg-cream-100 dark:bg-ink-950 divide-y divide-gray-200/40 dark:divide-ink-800/40">
          {filtered.length === 0 ? (
