...
export default function AboutPanel({ setCurrentPage }: AboutPanelProps) {
  ...
  return (
    <div id="about-panel-root" className="bg-[#F8F8F6] text-[#1C1C1C] pt-24 pb-16">
      
      {/* Editorial Header Section */}
      <section className="py-20 relative bg-gradient-to-b from-[#0A2E5D] to-sky-950 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="relative p-2 bg-white border border-gray-150 rounded-3xl shadow-sm overflow-hidden aspect-square flex flex-col justify-between">
                <div className="flex-1 bg-gradient-to-tr from-[#0A2E5D] to-[#123C73] rounded-2xl relative p-8 flex flex-col justify-between overflow-hidden">
                  
                  {/* Glowing background */}
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(200,155,60,0.15),transparent_50%)]" />
                  
                  <div className="flex justify-between items-start relative z-10">
                    <span className="text-xs font-mono tracking-widest text-[#C89B3C] bg-white/10 px-2.5 py-1 rounded-md uppercase font-bold">HISTÓRICO</span>
                    <Scale size={20} className="text-[#C89B3C]" />
                  </div>

                  <div className="space-y-4 relative z-10">
                    <span className="text-6xl font-serif font-bold text-white/10 block leading-none">2026</span>
                    <h3 className="text-xl font-serif font-semibold text-white leading-tight">Uma Visão Global em Solo Angolano</h3>
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <h2 className="text-3xl font-serif font-black text-[#0A2E5D]">História da MultiPlus Academy</h2>
      ...
      <section className="py-24 bg-gradient-to-b from-[#F8F8F6] to-[#ECECE8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
            ...
            <div className="neo-card p-10 rounded-3xl relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="space-y-6">
                <div className="w-12 h-12 rounded-xl bg-[#0A2E5D]/5 flex items-center justify-center text-[#C89B3C]">
                  <Flag size={20} />
                </div>
                <h3 className="text-2xl font-serif font-bold text-[#0A2E5D]">Nossa Missão</h3>
            ...
            {/* Visão Card */}
            <div className="neo-card p-10 rounded-3xl relative overflow-hidden flex flex-col justify-between">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#0A2E5D]/5 rounded-full pointer-events-none" />
              <div className="space-y-6">
                <div className="w-12 h-12 rounded-xl bg-[#0A2E5D]/5 flex items-center justify-center text-[#C89B3C]">
                  <Compass size={20} />
                </div>
                <h3 className="text-2xl font-serif font-bold text-[#0A2E5D]">Nossa Visão</h3>
                <p className="text-sm text-[#1C1C1C]/80 leading-relaxed font-sans">
          ...
          <div className="text-center max-w-xl mx-auto mb-16 space-y-4">
            ...
            <h3 className="text-2xl sm:text-3xl font-serif font-bold text-[#0A2E5D]">Valores Fundamentais</h3>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((v, i) => (
              <div key={i} className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm text-left flex flex-col justify-between space-y-4 hover:shadow-md transition-shadow">
                <div className="w-10 h-10 rounded-lg bg-[#0A2E5D]/5 flex items-center justify-center text-[#C89B3C]">
                  {v.icon}
                </div>
                <div>
                  <h4 className="font-serif font-bold text-[#0A2E5D] text-base">{v.title}</h4>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center mb-20 space-y-4">
            ...
            <h3 className="text-3xl sm:text-4xl font-serif font-black text-[#0A2E5D]">Nossa Equipa Científica</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto items-stretch">
            ...
            <div className="bg-gradient-to-b from-gray-50 to-white border border-gray-100 rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col">
              <div className="aspect-[4/3] bg-gradient-to-b from-[#0A2E5D] to-sky-950 relative overflow-hidden flex items-center justify-center pt-6">
                <img
                ...
                <div className="absolute top-4 right-4 bg-[#C89B3C] text-white font-mono text-[9px] font-bold px-2.5 py-1 rounded uppercase tracking-wider shadow">
                  Direção Letiva
                </div>
              </div>
              ...
              <div className="p-8 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  <h4 className="text-xl font-serif font-bold text-[#0A2E5D]">{MAIN_INSTRUCTOR.name}</h4>
                  <p className="text-xs text-[#C89B3C] font-semibold tracking-wide uppercase font-mono mt-1">Diretora Pedagógica & Tradutora ATIA</p>
                ...
                <div className="pt-4 border-t border-gray-100 flex justify-between items-center text-xs">
                  <span className="font-mono text-gray-400">15+ Anos de Carreira</span>
                  <button 
            ...
            <div className="bg-gray-100/50 border border-dashed border-gray-200 rounded-3xl p-8 flex flex-col items-center justify-center text-center space-y-4">
              <div className="w-20 h-20 rounded-full bg-gray-200/50 flex items-center justify-center border border-gray-300/30 text-[#C89B3C]">
                <GraduationCap size={32} />
              </div>
              <div className="space-y-2">
                <h4 className="text-lg font-serif font-bold text-[#0A2E5D]/60">Vaga letiva em aberto</h4>
              ...
              <button 
                ...
                className="px-4 py-2 bg-white hover:bg-gray-50 text-[#0A2E5D] border border-gray-200 text-[10px] font-mono font-bold uppercase rounded-lg tracking-wider transition-all"
              >
      ...
      <section className="py-20 relative bg-gradient-to-br from-[#0A2E5D] to-[#123C73] text-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="pt-4">
            <button
              ...
              className="px-8 py-3.5 bg-[#C89B3C] hover:bg-[#D4A747] text-white rounded-xl uppercase tracking-wider text-xs font-bold transition-all shadow-[0_4px_12px_rgba(200,155,60,0.25)]"
            >
